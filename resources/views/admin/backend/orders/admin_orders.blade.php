                    ...
                    <h4>Payment Details</h4>
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                              ...
                              <div class="row mb-3">
                                <div class="col-sm-3">
                                     <h6 class="mb-0" style="white-space: nowrap;">Payment Type </h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card">   
                        ...
                        <div class="card-body">    
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0" style="white-space: nowrap;">Total Amount</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                            ...
                            <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0" style="white-space: nowrap;">Invoice Number </h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                              ...
                              <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0" style="white-space: nowrap;">Order Date</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
